...
\begin{table*}[ht]
	\centering
		...
		\multicolumn{1}{|c}{Höhe Massenschwerpunkt} & \multicolumn{1}{c} {$l$} &  \multicolumn{1}{c} {0.236 m} & \multicolumn{1}{c|} {SolidEdge}  \\ \hline
		\multicolumn{1}{|c}{Höhe Körper} & \multicolumn{1}{c} {$h$} &  \multicolumn{1}{c} {0.366 m} & \multicolumn{1}{c|} {SolidEdge}  \\ \hline
		...
		\multicolumn{1}{|c}{\begin{tabular}[c]{@{}c@{}}Trägheitsmoment der virtuellen Räder\\ ($yz$- und $xz$-Ebene)\end{tabular}}  & \multicolumn{1}{c} {$I_{W,yz, xz}$} & \multicolumn{1}{c} {0.00357 $kgm^{2}$} & \multicolumn{1}{c|} {Berechnet}\\ \hline
...
\begin{table}[H]
	\centering
	\caption{Übersicht über die verwendeten Bauteile}
	\label{bauteile1}
...
\begin{figure}[htbp]%
	...
	\caption{Übersicht des Simulink Simulationsaufbaus}
\end{figure}
