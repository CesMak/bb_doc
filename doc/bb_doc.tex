...
\begin{tabular}{l l l l l}
	...
	Battery: LI-PO 11.1 1800mAh LB-12 19&1&150 &\mylink{https://nodna.de/Robotis-LIPO-111V-Akkupack-1800mAh-LBS-012}{\EUR{44.90}} &
...
But if the max vel limit is too slow and a constant force is applied dann wird sehr schnell das max vel limit ueberschritten und daher springt es beim effort control immer wieder auf 0!

Die Ausgabe der joint states der velocity ist in rad pro sec.! bei den continuous joints
...
\begin{enumerate}
	...
	\subsection{Friction Omniwheels - Ball}
	Yellow Ball, double omniwheel friction: The motor starts to turn at 11 Units so the offset threshold is 10 Units. Which is 47.4mNm (when 4.3mNm/Unit - Factor is 232).
	
	\chapter{Testing to balance}
	good values:
	\begin{itemize}
		\item ohne filter, K exp = 12, Alpha = 40, Beta = -120, sample time 6ms
	\end{itemize}
