...
\section{Auswertung}
Nach der Implementierung wurde die Regelung wie in Kapitel \ref{ch:Modellierung} beschrieben am realen Ballbot getestet. Abbildung \ref{fig:ballbot_real} zeigt den Aufbau des Ballbots, wie er auf dem Ball balanciert. Für dieses balancierende Experiment wurden zusätzlich die Winkel der IMU und die realen Drehmomente der Motoren aufgenommen. Diese sind in Abbildung \ref{fig:ballbot_balancieren} dargestellt.
\begin{figure}[h!]
	\centering
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.2]{./Bilder/Florian/ballbot_real.png}
	\caption{Finale Messdaten.}
	\label{fig:ballbot_balancieren}
\end{figure}
